...
class ImageUploadertwo extends ComponentBase
{
    ...
    //break;
      //$this->fileList = $fileList = $this->getFileList();
        ...
        $this->fileListtwo= $this->page['fileListtwo'] = $this->getFileList();
        $this->singleFiletwo= $this->page['singleFiletwo'] = $this->fileListtwo->first();
        //$this->singleFile = $fileList->first();
        
       // var_dump($this->getFileList());die;
    }
