...
import { injectStore } from 'app/routes'
  ...
  <html lang="en">
    ...
    <body>
      ...
      <div className="" style={{display:'none'}}>
        <script type="text/javascript" src="https://s22.cnzz.com/z_stat.php?id=1263968589&web_id=1263968589" language="JavaScript"/>
      </div>
    </body>
  </html>
)
