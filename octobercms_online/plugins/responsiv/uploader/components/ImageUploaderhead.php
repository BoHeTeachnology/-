...
class ImageUploaderhead extends ComponentBase
{
    ...
    //break;
      //$this->fileList = $fileList = $this->getFileList();
        ...
        $this->fileListhead= $this->page['fileListhead'] = $this->getFileList();
        $this->singleFilehead= $this->page['singleFilehead'] = $this->fileListhead->first();
