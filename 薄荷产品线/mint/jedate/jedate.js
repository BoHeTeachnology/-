	...
	*/
    ...
    InitDate.prototype = {
        ...
        setHtml:function(opts, self) {
            ...
            var bothmsStr = !isformat ? '<ul class="botflex jedatehms"><li><em data-hms="24"></em><i>:</i></li><li><em data-hms="60"></em><i>:</i></li><li><em data-hms="60"></em></li></ul>' + '<div class="botflex jedatebtn"><span class="jedatetodaymonth">今天</span><span class="jedateok">本月</span><span class="jedateclear">清空</span></div>' :'<div class="botflex jedatebtn"><span class="jedatetodaymonth" >今天</span><span class="jedateok" >本月</span><span class="jedateclear">清空</span></div>';
