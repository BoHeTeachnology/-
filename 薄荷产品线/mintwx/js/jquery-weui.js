  ...
  var Calendar = function (params) {
      ...
      p.updateValue = function () {
          ...
          for (i = 0; i < p.value.length; i++) {
              ...
              var Mon = (valueDate.getMonth()+1) <10 ? '0'+(valueDate.getMonth()+1) : (valueDate.getMonth()+1);
              var Dat = valueDate.getDate()<10 ? '0'+valueDate.getDate() : valueDate.getDate();
              p.wrapper.find('.picker-calendar-day[data_date="' + valueDate.getFullYear() + '-' + Mon + '-' + Dat + '"]').addClass('picker-calendar-day-selected');
          }
          if (p.params.onChange) {
      ...
      p.monthHTML = function (date, offset) {
          ...
          for (i = 1; i <= rows; i++) {
              ...
              for (j = 1; j <= cols; j++) {
                  ...
                  var dayMothMon = (dayMonth+1)<10? '0'+(dayMonth+1) : (dayMonth+1);
                  var dayNumberDay = dayNumber<10? '0'+dayNumber:dayNumber;
                  rowHTML += '<div data-year="' + dayYear + '" data-month="' + dayMonth + '" data-day="' + dayNumber + '" class="picker-calendar-day' + (addClass) + '" data-date="' + (dayYear + '-' + dayMonth + '-' + dayNumber) + '" data_date="' + (dayYear + '-' + dayMothMon + '-' + dayNumberDay) + '"><span>'+dayNumber+'</span></div>';
              }
  ...
  defaults = $.fn.calendar.prototype.defaults = {
    ...
    yearPickerTemplate:
        '<div class="picker-calendar-year-picker">' +
            '<a href="javascript:;" class="link icon-only picker-calendar-prev-year"><i class="icon icon-prev1"></i></a>' +
