$(function(){
    ...
    $('#add_btns').click(function(){
        sessionStorage.setItem('create_time_family','1')
        sessionStorage.setItem('from_family','see_family')
        location.href="/mint/html/user/edit_family.html#User";
    })
...
function loadTable(user_id,p,p_len){
