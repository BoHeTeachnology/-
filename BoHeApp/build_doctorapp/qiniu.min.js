/*! qiniu-js v1.0.16-beta | Copyright 2015 by Qiniu */ ! function(global) {
    ...
    window.localStorage || (window.localStorage = {
        setItem: function(a, b) { createCookie(a, b, 30) },
        getItem: function(a) {
            return readCookie(a)
        },
        removeItem: function(a) { createCookie(a, "", -1) }
    });
    ...
    function QiniuJsSDK() {
        ...
        this.resetUploadUrl = function() {
            ...
            logger.debug("new plupload.Uploader(option)"), j.bind("Init", function(b, d) { logger.debug("Init event activated"), a.get_new_uptoken || c(null) }), logger.debug("bind Init event"), j.bind("FilesAdded", function(a, b) {
                ...
                c && setTimeout(function() { a.start(), logger.debug("invoke up.start()") }, 0), a.refresh()
                ...
                f = f || a.settings && a.settings.chunk_size, f > e && (a.setOption({ url: qiniuUploadUrl + "/mkblk/" + e }), logger.debug("up.setOption url: ", qiniuUploadUrl + "/mkblk/" + e)), localStorage.setItem(b.name, that.stringifyJSON({ ctx: h, percent: b.percent, total: c.total, offset: c.offset, time: (new Date).getTime() }))
            ...
            var d;
            var e = this;
            return c.open("GET", b, !1), c.onreadystatechange = function() { 4 === c.readyState && 200 === c.status && (d = e.parseJSON(c.responseText)) }, c.send(), d
