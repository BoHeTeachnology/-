$(function(){
  ...
  AjaxObj.ClinicgetOne(function(result){
    if(result.Data.code ==1){
      ...
      $('#clinic_name,#clinicNamehtml').html( result.Data.data.clinic_name );
  ...
  AjaxObj.equipmentList(function(result){
      if(result.Data.code ==1){
        ...
        swiperFun('.swiper-container1','.swiper-button-next1','.swiper-button-prev1',2,1)
  ...
  $('#edit_clinic').click(function(){
    location.href='http://'+location.host+'/mint/html/caseList/edit.html#Clinic';
  })
