<?php
require_once "./Application/Tool/WxpayAPI/lib/WxPay.Exception.php";
require_once "./Application/Tool/WxpayAPI/lib/WxPay.Config.php";
require_once "./Application/Tool/WxpayAPI/lib/WxPay.Data.php";
...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		$inputObj->SetAppid(C('WX_APPID'));//公众账号ID
		$inputObj->SetMch_id(C('WX_MCHID'));//商户号
