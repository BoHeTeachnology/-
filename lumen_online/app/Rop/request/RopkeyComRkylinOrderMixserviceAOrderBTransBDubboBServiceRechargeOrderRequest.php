<?php
class RopkeyComRkylinOrderMixserviceAOrderBTransBDubboBServiceRechargeOrderRequest
{
     ...
     {
         return "ruixue.ropkey.com.rkylin.order.mixservice.a.order.b.trans.b.dubbo.b.service.recharge.order";
     }
