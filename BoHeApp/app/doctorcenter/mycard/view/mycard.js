...
export const MycardUi = ({
    ...
    <div style={{height:height}}>
    	<div style={{background:'#04b9c0',width:'100%',height:height*0.8,padding:'0.6rem 0.56rem'}} className='doctorCard'>
		    <div style={{height:'100%',width:'100%',position:'relative',borderRadius:'0.15rem',background:'url('+require('app/common/images/doctorcardbg.png')+') no-repeat',backgroundColor:'#fff'}}>
		    	<div style={{position:'absolute',width:'100%',height:'100%',padding:'0.6rem'}}>
		    		...
		    		<div style={{margin:'0.3rem auto',width:'80%'}}>
		    			<span style={{ width:'80%',textAlign:'center',overflow:'hidden',height:'0.28rem',lineHeight:'0.28rem',whiteSpace:'nowrap',margin:'0 auto',textOverflow:'ellipsis',fontSize:'0.28rem',display:'block'}}>{institution} ｜ {jobtitle}</span>
		    		</div>
    	...
    	<div style={{height:0.2*height,paddingTop:'0.2rem'}}>
			<Row style={{margin:'0'}}>
				<Col xs={12} style={{textAlign:'center'}}>
					<Image style={{ width:'1.5rem',height:'1.5rem',marginBottom:'0.2rem'}} src={require('app/common/images/doctorcardcode.jpg')}/>
