...
class ImageUploaderone extends ComponentBase
{
    ...
    //break;
      //$this->fileList = $fileList = $this->getFileList();
        ...
        $this->fileListone= $this->page['fileListone'] = $this->getFileList();
        $this->singleFileone= $this->page['singleFileone'] = $this->fileListone->first();
