...
class Type extends Model {
	...
	public $table = 'kurtjensen_mycal_types';
	...
	*/
	public $rules = [
		'name' => 'required',
		'slug' => 'required|between:3,64|unique:kurtjensen_mycal_types',
	];
	...
	public static function selector($selectedValue = null, $options = [], $name = 'type_id', $includeBlank = true) {
