...
class ImageUploaderthree extends ComponentBase
{
     ...
     * @var Collection
     */
    public $fileListthree;

    /**
     * @var Model
     */
    public $singleFilethree;
    ...
    //break;
      //$this->fileList = $fileList = $this->getFileList();
        ...
        $this->fileListthree= $this->page['fileListthree'] = $this->getFileList();
        $this->singleFilethree= $this->page['singleFilethree'] = $this->fileListthree->first();
