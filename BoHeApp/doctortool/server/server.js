...
import { configureStore } from 'doctortool/configure-store.js'

import routes from 'doctortool/routes'
...
app.use(express.static(path.join(__dirname, '..', 'build_doctortool')));
...
const HTML = ({ content, store }) => (
  <html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/doctortool.css"/>
    </head>
    <body>
