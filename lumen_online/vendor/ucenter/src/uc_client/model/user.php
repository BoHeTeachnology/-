...
class usermodel {
  ...
  function get_user_by_mobile($mobile){
    $arr = $this->db->fetch_first("SELECT * FROM ".UC_DBTABLEPRE."members WHERE phone='$mobile'");
    return $arr;
  }
  ...
  function check_phoneformat($phone) {
	...
	function add_user($username, $password, $email, $phone, $uid = 0, $questionid = '', $answer = '', $regip = '') {
